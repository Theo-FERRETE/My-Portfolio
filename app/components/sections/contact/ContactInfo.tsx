  ...
  return (
    <div className="space-y-6">
      <div className="glass-card p-5 sm:p-6 rounded-xl">
        <h2 className="text-lg sm:text-xl font-bold text-foreground">Pour bien démarrer</h2>
      ...
      <div className="glass-card p-5 sm:p-6 rounded-xl">
        <h2 className="text-lg sm:text-xl font-bold text-foreground">Ailleurs</h2>
      ...
      <div className="flex items-center gap-3 border border-accent-green/30 bg-accent-green/10 px-5 py-4 rounded-xl">
        <span className="w-2 h-2 shrink-0 rounded-full bg-accent-green" aria-hidden />
